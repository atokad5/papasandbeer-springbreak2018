	...
	<div class="inner cParent">
		...
		<div class="cParent__col">
			...
			<div class="content-area">
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea laboriosam pariatur rem blanditiis exercitationem. Nemo sed iure totam quia eum. Earum odit esse distinctio est magnam ad amet labore doloremque.
			</div>
			...
			<div class="content-area-social-links">
				<h2 class="dates hdr-el" id="top-content" style="margin: 0;">Follow us</h2>
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea laboriosam pariatur rem blanditiis exercitationem.
				<ul>
